        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-700 p-12 flex-col justify-between">
                <div className="text-white">
                    ...
                    <p className="text-xl text-blue-100">Access your courses, assignments, and track your academic progress in one place.</p>
                </div>
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-xl">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600">Access your learning materials</p>
                        </div>
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm text-gray-600">
                                ...
                                <a href="/signup/student" className="font-medium text-blue-600 hover:text-blue-500 transition-colors duration-200">
                                    Sign up
                                </a>
                            </p>
                        </div>
