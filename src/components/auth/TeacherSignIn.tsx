        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-600 to-emerald-700 p-12 flex-col justify-between">
                <div className="text-white">
                    ...
                    <h2 className="text-4xl font-bold mb-4">Welcome to Teacher Portal</h2>
                    <p className="text-xl text-green-100">Manage your classes, create assignments, and track student progress in one place.</p>
                </div>
