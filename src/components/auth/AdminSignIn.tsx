        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 to-indigo-700 p-12 flex-col justify-between">
                <div className="text-white">
                    ...
                    <h2 className="text-4xl font-bold mb-4">Welcome to Admin Portal</h2>
                    <p className="text-xl text-purple-100">Manage the entire learning platform and oversee all activities in one place.</p>
                </div>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-xl">
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm text-gray-600">
                                ...
                                <a href="/signup/admin" className="font-medium text-purple-600 hover:text-purple-500 transition-colors duration-200">
                                    Sign up
                                </a>
                            </p>
                        </div>
