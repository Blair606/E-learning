        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-600 to-emerald-700 p-12 flex-col justify-between">
                <div className="text-white">
                    ...
                    <h2 className="text-4xl font-bold mb-4">Join as a Teacher</h2>
                    <p className="text-xl text-green-100">Share your knowledge and manage your classes with our comprehensive teaching platform.</p>
                </div>
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-xl">
                        <div className="text-center mb-8">
                            <div className="mx-auto w-16 h-16 bg-green-500 rounded-full flex items-center justify-center mb-4 transform hover:scale-105 transition-transform duration-200">
                                <UserCircleIcon className="h-10 w-10 text-white" />
                            </div>
                            <h2 className="text-2xl font-bold text-gray-900 mb-2">Create Teacher Account</h2>
                            <p className="text-gray-600">Join our teaching platform</p>
                        </div>
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="mt-1 relative group">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <UserCircleIcon className="h-5 w-5 text-gray-400 group-focus-within:text-green-500 transition-colors duration-200" />
                                        </div>
                                        <input
                                            id="email"
                                            name="email"
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm text-gray-600">
                                ...
                                <a href="/signin/teacher" className="font-medium text-green-600 hover:text-green-500 transition-colors duration-200">
                                    Sign in
                                </a>
                            </p>
                        </div>
