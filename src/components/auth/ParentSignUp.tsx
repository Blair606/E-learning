            ...
            <div className="max-w-md w-full space-y-8">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                        Join our platform to monitor your children's progress
                    </p>
                </div>
                ...
                <div className="text-center">
                    <p className="text-sm text-gray-600">
                        ...
                        <a href="/signin/parent" className="font-medium text-purple-600 hover:text-purple-500 transition-colors duration-200">
                            Sign in
                        </a>
                    </p>
                </div>
